...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/XXX/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zhen', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'BIO Learning with Lucas', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.connectworlds.uk/', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/XXX
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/XXX
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备11951850', // 备案号 闽ICP备XXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Learning with Lucas', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '英语学习网站', // 站点描述，被notion中的页面描述覆盖
